                            ...
                            <div class="row">
                                ...
                                <div class="col-auto">
                                    <form id="deleteForm" method="POST" action="">
                                        @csrf
                                        @method('DELETE')
                                        <button onclick="event.preventDefault(); deleteSelected('{{ route('vendors.delete', ['selectedIds' => '']) }}')" type="submit" class="btn btn-danger float-right">Delete Selected</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($vendors as $vendor)
                                        <tr>
                                            ...
                                            <td>
                                                <a type="button"
                                                    href="{{ URL::route('vendors.edit', [$vendor->id]) }}"
