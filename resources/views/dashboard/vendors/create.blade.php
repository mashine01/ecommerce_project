            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ isset($vendor) ? route('vendors.update',['vendor'=>$vendor]) : route('vendors.store') }}" method="POST" enctype="multipart/form-data">
                            @if (isset($vendor))
                                @method('PUT')
                            @else
                                @method('POST')
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    placeholder="Enter Vendor Name" value="{{isset($vendor) ? $vendor->name : ''}}" required>
                                </div>
                            </div>
                            <!-- /.card-body -->
