                        ...
                        <form action="{{ isset($brand) ? route('brands.update',['brand'=>$brand]) : route('brands.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    placeholder="Enter Brand Name" value="{{isset($brand) ? $brand->name : ''}}" required>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="vendor_id" class="form-control" id="vendor_id" required>
                                        ...
                                        @foreach ($vendors as $vendor)
                                            <option value="{{ $vendor->id }}" {{ isset($brand) && $brand->vendor_id == $vendor->id ? 'selected' : '' }}>{{ $vendor->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
