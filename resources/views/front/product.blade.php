                                ...
                                <div class="product-gallery product-gallery-vertical">
                                    <div class="row">
                                        <figure class="product-main-image">
                                            <img id="product-zoom" src="{{ asset($product->front_image) }}"
                                                data-zoom-image="{{ asset($product->front_image) }}
                                                alt="product
                                                image">
                                        ...
                                        <div id="product-zoom-gallery" class="product-image-gallery">
                                            <a class="product-gallery-item active" href=""
                                                data-image="{{ $product->front_image }}"
                                                data-zoom-image="{{ $product->front_image }}">
                                                <img src="{{ $product->front_image }}" alt="product side">
                                            </a>

                                            <a class="product-gallery-item" href=""
                                                data-image="{{ asset($product->left_image) }}"
                                                data-zoom-image="{{ asset($product->left_image) }}">
                                                <img src="{{ asset($product->left_image) }}" alt="product cross">
                                            </a>

                                            <a class="product-gallery-item" href=""
                                                data-image="{{ asset($product->right_image) }}"
                                                data-zoom-image="{{ asset($product->right_image) }}">
                                                <img src="{{ asset($product->right_image) }}" alt="product with model">
                                            </a>

                                            <a class="product-gallery-item" href=""
                                                data-image="{{ asset($product->back_image) }}"
                                                data-zoom-image="{{ asset($product->back_image) }}">
                                                <img src="{{ asset($product->back_image) }}" alt="product back">
                                            </a>
                                        ...
                                        <div class="select-custom">
                                            <select name="size" id="size" class="form-control">
                                                ...
                                                @foreach ($variants as $variant)
                                                    <option value="{{ $variant->colour }}">{{ $variant->colour }}
                                                    </option>
                                                @endforeach
                                            </select>
        ...
        <div class="container">
            <div class="row">
                <div class="col-6">
                    ...
                    <h4 class="product-title"><a href="product.html"> {{ $product->name }}</a></h4>
                    <!-- End .product-title -->
                </div><!-- End .col-6 -->
                ...
                <div class="col-6 justify-content-end">
                    ...
                    <div class="product-details-quantity">
                        <input type="number" id="sticky-cart-qty" class="form-control" value="1"
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            galleryItems.forEach(function(item) {
                item.addEventListener('click', function(event) {
                    ...
                    // Get the image and zoom image URLs from data attributes
                    var imageUrl = this.getAttribute('data-image');
                    var zoomImageUrl = this.getAttribute('data-zoom-image');

                    // Update the src and data-zoom-image attributes of the product zoom image
                    document.getElementById('product-zoom').setAttribute('src', imageUrl);
                    document.getElementById('product-zoom').setAttribute('data-zoom-image',
                        zoomImageUrl);
                });
            });
        });
